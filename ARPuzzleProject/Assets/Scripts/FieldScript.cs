...
public class FieldScript : MonoBehaviour
{
    ...
    public void backwardButtonAction(){
    ...
    public void leftwardButtonAction(){
    ...
    void assignReflectionMaterials(LinkedList<GameObject> reflectionObjects, string pieceName)
    {
        ...
        while (currNode != null)
        {
            ...
            currValue.GetComponent<MeshRenderer>().shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off;
    ...
    LinkedList<GameObject> createPieceGameObject(LinkedList<Vector3> tempSet, bool outlineBool, string tempString)
    {
        ...
        foreach (var element in tempSet)
        {
            ...
            else
            {
                ...
                currentCube.GetComponent<MeshRenderer>().shadowCastingMode = UnityEngine.Rendering.ShadowCastingMode.Off;  
            }
